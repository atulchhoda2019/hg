...
def _mask_inputs(inputs: dict[str, Any]) -> dict[str, Any]:
    """Guest payloads enter traces as refs and field names, never raw values."""
...
def run_config(conversation_id: str, brand_id: str, versions: dict[str, str]) -> dict[str, Any]:
    ...
    return {
        ...
        "tags": [brand_id, "mocked-data-plane"],
